...
### 3.1. Domain Modules
*   **`medicine`**:
    *   **Search**: Combined brand/generic search.
    *   **Products**: Detailed brand product variations, strengths, and pack sizes.
    *   **Warnings**: Semantic and rule-based interaction checking.
    *   **Diseases**: Mapping diseases to recommended generics.
*   **`lab-test`**:
...
medicine-server-frontend/  # Frontend Next.js Application
└── src/
...
The project includes a Next.js 15 frontend located in `medicine-server-frontend/`. 
...
- **Documentation**: Refer to `medicine-server-frontend/GEMINI.md` for specific frontend architectural guidelines.
